...
- Evaluation run: `phase6-v130-regression-keyword-r01`
...
| full_diagnosis_p95_seconds | 32.265253624878824 |
| first_event_p95_seconds | 0.19535750010982156 |
...
- Hybrid vector retrieval was not enabled for this run.
- External reranking was not enabled for this run.
